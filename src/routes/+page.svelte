    ...
    <div class="flex gap-2 justify-between">
      <div class="flex flex-row justify-start items-center gap-5">
        ...
        <div>
          ...
          <p class="text-sm">Technology Lead, Marketer, Coach</p>
        </div>
      </div>
    </div>
  </Column>
